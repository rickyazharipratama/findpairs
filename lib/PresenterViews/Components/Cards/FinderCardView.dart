...
class FinderCardView{
  ...
  Size get cardSize{
    ...
    double roomHeight = MediaQuery.of(currentContext()).size.height - (MediaQuery.of(currentContext()).padding.top + MediaQuery.of(currentContext()).padding.bottom + stacked + 60 /* header */ + 80 /* hint */);
